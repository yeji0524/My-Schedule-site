...
import ActorCalendar from "@/components/ActorCalendar";
...
const myInfo = {
  ...
  greeting: "안녕하세요!",
  description:
    "저는  김예지입니다. 업무 외 시간에는 뮤지컬 관람을 즐기며, 공연 예술을 통해 영감을 얻고 있습니다. 이 포트폴리오는 제 관심사와 경험을 담은 공간입니다.",
  highlights: [
    "뮤지컬 관람",
    "공연 예술 탐구",
    "연구",
...
// ============================================
// 고은성 캐스팅 일정
const goeunseongCasting = [
  { date: "2026-03-10", show: "데스노트", time: "19:00" },
  { date: "2026-03-11", show: "데스노트", time: "19:00" },
  { date: "2026-03-15", show: "데스노트", time: "14:00" },
  { date: "2026-03-18", show: "데스노트", time: "19:00" },
  { date: "2026-03-21", show: "데스노트", time: "14:00" },
  { date: "2026-03-22", show: "데스노트", time: "14:00" },
  { date: "2026-03-25", show: "데스노트", time: "14:00" },
  { date: "2026-03-26", show: "데스노트", time: "19:30" },
  { date: "2026-03-28", show: "데스노트", time: "19:00" },
];

// 김성철 캐스팅 일정
const kimseongcheolCasting = [
  { date: "2026-03-11", show: "데스노트", time: "19:00" },
  { date: "2026-03-28", show: "데스노트", time: "19:00" },
];
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* 고은성 캐스팅 일정 섹션 */}
      <section id="goeunseong" className="py-20 px-6 bg-neutral-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">고은성</h2>
          <p className="text-center text-neutral-600 mb-12">현재 진행중인 공연 캐스팅 일정</p>
          <ActorCalendar actorName="고은성" castingDates={goeunseongCasting} />
        </div>
      </section>

      {/* 김성철 캐스팅 일정 섹션 */}
      <section id="kimseongcheol" className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">김성철</h2>
          <p className="text-center text-neutral-600 mb-12">현재 진행중인 공연 캐스팅 일정</p>
          <ActorCalendar actorName="김성철" castingDates={kimseongcheolCasting} />
        </div>
      </section>
